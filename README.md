...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gmuxw2q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gmuxw2q.containers.anotherwebservice.com/
...
```
git clone git@github.com:Meowdharchod/SBTeraBot.git
cd container-gmuxw2q
```
...
```
docker attach container-gmuxw2q
```
